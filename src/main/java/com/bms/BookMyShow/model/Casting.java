...
public class Casting extends BaseModel {
  /**
   * 1 Casting can have 1 Profile ->  Robert Downey Jr is an Actor/Male/Height: 1.74 m
   * 1 Profile can be associated with a single Casting -> Actor/Male/Height: 1.74 m is  Robert Downey Jr
   */
  @OneToOne
  private Profile profile;
  /**
   * 1 Casting can have multiple CastType ->  Shah Rukh Khan is an Actor,Producer
   * 1 CastType can be associated with a multiple Casting -> Actor,Producer are Shah Rukh Khan,Amir Khan
   */
//  @ManyToMany
  @ElementCollection
